    ...
    <div class="info-card-body">
      ...
      <section v-if="qrz">
        <IconInfo
                ...
                :title="qrz"
        >
          <svg data-v-9f2c2938="" class="icon" style="font-size: 1em;"><title data-v-9f2c2938="">yl3lk@lrg.lv</title><use data-v-9f2c2938="" xlink:href="#icon-organization"></use></svg> QRZ.com
        </IconInfo>
      </section>
      </section>
